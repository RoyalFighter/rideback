...
const io = new socketIO.Server(httpServer, {
  cors: {
    origin: process.env.CORS_ORIGIN || 'http://localhost:3000' || 'https://meek-babka-71c876.netlify.app' || 'http://192.168.1.6:3000', // Use an environment variable
    methods: ['GET', 'POST'],
  },
});
...
app.use(
  cors({
    origin: ['http://localhost:3000', 'https://meek-babka-71c876.netlify.app', 'http://192.168.1.6:3000'],
    credentials: true,
  })
);
